...
<p align="center">
  <a href="./DESIGN-PROMO.zh-CN.md#它的设计哲学">💡 设计理念</a> ·
...
> - 🧠 **想懂设计原理** → [DESIGN-PROMO.zh-CN.md · 设计理念](./DESIGN-PROMO.zh-CN.md) ｜ [workflow-overview.md · 机制全景](./docs/workflow-overview.md)
>
> **文档地图（三份分工，别重复读）**：本 **README** = 门面 + 安装 + 命令速查；**[DESIGN-PROMO](./DESIGN-PROMO.zh-CN.md)** = 为什么这么设计（理念深挖，适合推广）；**[workflow-overview](./docs/workflow-overview.md)** = 2 模型 / 4 阶段 / 命令的机制全景（适合培训讲解）。
